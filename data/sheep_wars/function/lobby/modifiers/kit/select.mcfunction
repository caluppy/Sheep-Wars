...
execute if score @s sheep_wars.options matches 6 run scoreboard players set @s sheep_wars.options 0
...
execute if score @s sheep_wars.options matches 4 run title @s actionbar [{"text":"Kit Selected:","color":"gold","underlined":true},{"text":" Archer","underlined":false,"color":"green"}]
execute if score @s sheep_wars.options matches 5 run title @s actionbar [{"text":"Kit Selected:","color":"gold","underlined":true},{"text":" Miner","underlined":false,"color":"dark_gray"}]
