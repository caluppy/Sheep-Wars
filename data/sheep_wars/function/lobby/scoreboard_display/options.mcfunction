...
execute if score #spawnrate sheep_wars.options matches 1 run team modify display.lobby.spawnrate suffix {"text":" Slow","color":"green"}
...
execute if score #spawnrate sheep_wars.options matches 3 run team modify display.lobby.spawnrate suffix {"text":" Fast","color":"green"}