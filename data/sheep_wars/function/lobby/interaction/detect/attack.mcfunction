...
execute if predicate sheep_wars:lobby/interaction/friendly_fire on attacker at @s run function sheep_wars:lobby/modifiers/options/friendly_fire/remove
execute if predicate sheep_wars:lobby/interaction/bounce on attacker at @s run function sheep_wars:lobby/modifiers/options/bounce/remove
