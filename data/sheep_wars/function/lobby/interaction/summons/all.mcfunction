...
##maps
summon minecraft:interaction 10006 41 10000 {width:1,height:3,response:true,Tags:["sheep_wars.lobby","sheep_wars.click.map"],attack:{timestamp:0},interaction:{timestamp:0},Passengers:[{id:"text_display",text:[{"text":"Map:\n","color":"green","bold":true},{"text":"(Change)","color":"red","bold":false}],billboard:"vertical",transformation:{"left_rotation":[0,0,0,1],"right_rotation":[0,0,0,1],scale:[1,1,1],translation:[0,-1.5,0]}}]}

##gamemode
summon minecraft:interaction 9994 41 10000 {width:1,height:3,response:true,Tags:["sheep_wars.lobby","sheep_wars.click.gamemode"],attack:{timestamp:0},interaction:{timestamp:0},Passengers:[{id:"text_display",text:[{"text":"Gamemode:\n","color":"green","bold":true},{"text":"(Change)","color":"red","bold":false}],billboard:"vertical",transformation:{"left_rotation":[0,0,0,1],"right_rotation":[0,0,0,1],scale:[1,1,1],translation:[0,-1.5,0]}}]}

##options
summon minecraft:interaction 10000 41 9994 {width:1,height:3,response:true,Tags:["sheep_wars.lobby","sheep_wars.click.spawnrate"],attack:{timestamp:0},interaction:{timestamp:0},Passengers:[{id:"text_display",text:[{"text":"Item\nSpawnrate:\n","color":"green","bold":true},{"text":"(Change)","color":"red","bold":false}],billboard:"vertical",transformation:{"left_rotation":[0,0,0,1],"right_rotation":[0,0,0,1],scale:[1,1,1],translation:[0,-1.5,0]}}]}
