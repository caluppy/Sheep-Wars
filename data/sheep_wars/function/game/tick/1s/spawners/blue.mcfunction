...
scoreboard players operation #spawner.cooldown.final.blue sheep_wars.options /= #spawner.cooldown.modifier.generic sheep_wars.options
scoreboard players operation #spawner.cooldown.final.blue sheep_wars.options /= #spawner.cooldown.modifier.blue sheep_wars.options
scoreboard players operation #spawner.cooldown.final.blue sheep_wars.options /= #10000 constants
