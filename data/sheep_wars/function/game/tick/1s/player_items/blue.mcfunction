...
scoreboard players operation #item.cooldown.final.blue sheep_wars.options /= #cooldown.modifier.generic sheep_wars.options
...
execute as @a[tag=sheep_wars_player,team=sheep_wars.blue] run function sheep_wars:game/tick/1s/player_items/give_items