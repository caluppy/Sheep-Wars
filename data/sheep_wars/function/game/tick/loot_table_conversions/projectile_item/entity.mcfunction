...
execute if predicate sheep_wars:projectile/item/gray_dye run summon item ~ ~0.210 ~ {CustomNameVisible:1b,CustomName:{"text":"Squid Bomber","color":"gray","bold":true},Tags:["sheep_wars.summon_item.generic"],NoGravity:1b,Item:{id:"gray_dye",components:{"item_name":{"text":"Squid Bomber","color":"gray","bold":true},"item_model":"gray_wool","consumable":{consume_seconds:2147483647},"custom_data":{"right_click":true}}},Motion:[0,0.02,0],Health:10}
