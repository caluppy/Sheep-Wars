...
execute if score #map time matches 7 unless entity @a[predicate=sheep_wars:player/alive] as @a[predicate=sheep_wars:player/on_team] at @s run playsound minecraft:entity.villager.trade master @s ~ ~ ~ 1 0
