...
item replace entity @s weapon.offhand with crossbow[unbreakable={},enchantment_glint_override=false,enchantments={binding_curse:1,power:2},tooltip_display={hidden_components:[enchantments,unbreakable]}]
