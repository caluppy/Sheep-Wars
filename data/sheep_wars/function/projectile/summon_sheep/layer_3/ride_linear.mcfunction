...
execute store result entity @s Motion[1] double 0.001 store result score @s velocity.y run scoreboard players operation @s position.y -= @s previous.position.y
