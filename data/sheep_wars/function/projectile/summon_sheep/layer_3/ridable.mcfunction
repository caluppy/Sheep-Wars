...
$execute as @n[predicate=sheep_wars:projectile/clean/riding_motion_marker,name=$(playerUUID)] run scoreboard players set @s player_UUID_0 $(playerUUID)
$execute as @n[predicate=sheep_wars:projectile/clean/riding_motion_marker,name=$(playerUUID)] run scoreboard players set @s entity_UUID_0 $(entityUUID)
