...
$execute at @s anchored eyes run summon minecraft:sheep ^ ^ ^1 {attributes:[{id:"scale",base:0.5},{id:"minecraft:fall_damage_multiplier",base:0},{id:"minecraft:gravity",base:0.02},{id:"minecraft:air_drag_modifier",base:0}],Rotation:$(Rotation),data:{"playerUUID":$(UUID)},OnGround:0b,DeathLootTable:"minecraft:empty",Tags:["sheep_wars.motion.linear","sheep_wars.ridable","sheep_wars.explosion.small","sheep_wars.projectile.new"]}
