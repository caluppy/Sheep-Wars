...
$execute at @s anchored eyes run summon minecraft:sheep ^ ^ ^ {Color:10,attributes:[{id:"scale",base:1.2},{id:"movement_speed",base:0},{id:"minecraft:gravity",base:0.03},{id:"knockback_resistance",base:0.8},{id:"minecraft:fall_damage_multiplier",base:0},{id:"minecraft:air_drag_modifier",base:0}],Rotation:$(Rotation),data:{"owner":$(UUID),"playerUUID":$(UUID)},OnGround:0b,DeathLootTable:"minecraft:empty",Tags:["sheep_wars.motion.linear","sheep_wars.type.slow","sheep_wars.projectile.new"]}
