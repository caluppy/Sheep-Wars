...
execute unless entity @s[predicate=sheep_wars:summon_type/mortar_sheep] store result entity @s Motion[1] double 0.001 run scoreboard players get @s velocity.y
execute store result entity @s Motion[2] double 0.001 run scoreboard players get @s velocity.z

execute if predicate sheep_wars:summon_type/ride_fast_sheep run scoreboard players set @s new_projectile.is_riding 0
...
execute if predicate sheep_wars:summon_type/ride_fast_sheep if score @s new_projectile.is_riding matches 0 run function sheep_wars:projectile/summon_sheep/layer_3/ridable_dismount with entity @s data
