...
execute if predicate sheep_wars:projectile/summon_type/ride_fast_sheep if predicate sheep_wars:projectile/properties/ridable run scoreboard players set @s new_projectile.is_riding 0
execute if predicate sheep_wars:projectile/summon_type/ride_fast_sheep if predicate sheep_wars:projectile/properties/ridable store success score @s new_projectile.is_riding on passengers run scoreboard players set @s new_projectile.is_riding 1
