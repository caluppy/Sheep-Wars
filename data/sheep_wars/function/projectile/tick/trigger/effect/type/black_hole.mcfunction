...
execute if predicate sheep_wars:projectile/properties/team_blue facing entity @n[predicate=sheep_wars:projectile/summon_type/black_hole_sheep,team=sheep_wars.red,distance=..10] feet rotated ~ 0 if predicate sheep_wars:player/in_air run tp ^ ^ ^0.13
execute if predicate sheep_wars:projectile/properties/team_red facing entity @n[predicate=sheep_wars:projectile/summon_type/black_hole_sheep,team=sheep_wars.blue,distance=..10] feet rotated ~ 0 if predicate sheep_wars:player/in_air run tp ^ ^ ^0.13
execute if predicate sheep_wars:projectile/properties/team_none facing entity @n[predicate=sheep_wars:projectile/summon_type/black_hole_sheep,team=sheep_wars.none,distance=..10] feet rotated ~ 0 if predicate sheep_wars:player/in_air run tp ^ ^ ^0.13
...
execute if predicate sheep_wars:projectile/properties/team_none if entity @n[predicate=sheep_wars:projectile/summon_type/black_hole_sheep,distance=..3] run effect give @s slowness 1 1 true
