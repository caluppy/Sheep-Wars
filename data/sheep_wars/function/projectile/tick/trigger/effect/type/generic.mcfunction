...
execute if score tick time matches 19 run function sheep_wars:projectile/tick/trigger/effect/time
...
##1t effects
execute if predicate sheep_wars:projectile/summon_type/black_hole_sheep as @a[predicate=sheep_wars:player/alive,distance=..10] at @s run function sheep_wars:projectile/tick/trigger/effect/type/black_hole
