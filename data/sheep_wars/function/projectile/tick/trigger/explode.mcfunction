...
$execute if entity @s[predicate=sheep_wars:projectile/summon_type/air_strike] at @s run summon tnt ~ ~ ~ {fuse:5b,explosion_power:6,owner:$(owner),CustomName:{"text":"Air Strike","color":"gold"}}
