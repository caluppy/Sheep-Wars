...
execute if predicate sheep_wars:player/team_none run effect give @s saturation 1 5 true
...
execute if predicate sheep_wars:player/team_blue run effect give @a[predicate=sheep_wars:player/team_blue] saturation 1 5 true
...
execute if predicate sheep_wars:player/team_red run effect give @a[predicate=sheep_wars:player/team_red] saturation 1 5 true
