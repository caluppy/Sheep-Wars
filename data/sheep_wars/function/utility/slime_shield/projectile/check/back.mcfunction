...
execute store success score @s projectile.bounce positioned ^ ^-0.3 ^-0.3 as @e[predicate=sheep_wars:projectile/properties/do_collision,distance=..1.3] run scoreboard players set @s projectile.bounce -7
...
execute store success score @s projectile.bounce positioned ^-2 ^-0.3 ^-0.3 as @e[predicate=sheep_wars:projectile/properties/do_collision,distance=..1.3] run scoreboard players set @s projectile.bounce -7
