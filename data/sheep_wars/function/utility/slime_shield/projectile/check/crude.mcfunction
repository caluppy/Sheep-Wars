...
execute positioned ^ ^ ^1 if entity @e[predicate=sheep_wars:projectile/properties/do_collision_slime,distance=..3.5] run function sheep_wars:utility/slime_shield/projectile/check/front
execute positioned ^ ^ ^-1 if entity @e[predicate=sheep_wars:projectile/properties/do_collision_slime,distance=..3.5] run function sheep_wars:utility/slime_shield/projectile/check/back