...
execute as @e[predicate=sheep_wars:projectile/properties/do_collision_slime] unless score @s projectile.bounce matches 0 run function sheep_wars:utility/slime_shield/projectile/cooldown/function
