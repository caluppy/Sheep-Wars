...
execute store result entity @s Motion[0] double 0.0015 run scoreboard players get @s velocity.x
execute store result entity @s Motion[1] double 0.0015 run scoreboard players get @s velocity.y
execute store result entity @s Motion[2] double 0.0015 run scoreboard players get @s velocity.z
