...
$execute anchored eyes run summon interaction ^ ^ ^4 {Rotation:$(Rotation),data:{"playerUUID":$(UUID)},"Passengers":[{id:"block_display",Glowing:0b,Rotation:$(Rotation),block_state:{Name:"slime_block"},"transformation":{scale:[5f,4f,1f],translation:[-2.5f,-2f,-0.5f],right_rotation:[0f,0f,0f,1f],left_rotation:[0f,0f,0f,1f]}}],Tags:["sheep_wars.utility.new"]}
