...
execute positioned 10000 0 10000 as @e[type=interaction,distance=..500] at @s rotated as @s run function sheep_wars:utility/slime_shield/projectile/check/crude with entity @s
