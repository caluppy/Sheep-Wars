...
execute positioned 10000 0 10000 as @e[predicate=sheep_wars:summon_type/ride_carpet_squid,distance=..500] at @s run function sheep_wars:projectile/tick/ridable with entity @s data
